...
export class AuthService {
  ...
  async login(loginData: LoginData) {
    try {
      ...
      console.log("Error admin (si hay):", adminError);
      ...
      console.log("Error docente (si hay):", docenteError);
      ...
      console.log("Buscando en tabla estudiantes...");
      ...
      console.log("Error estudiante (si hay):", estudianteError);
      ...
      if (estudiante) {
        ...
        return {
          success: true,
          user: data.user,
          profile: { ...estudiante, rol: "estudiante" } as UserProfile,
        };
      }

      console.error(
        "Usuario NO encontrado en administradores, docentes ni estudiantes"
      );
